...
function addElement (cameras) {
    ...
    newDiv.classList.add("d-flex","justify-content-evenly", "flex-wrap", "row-cols-auto");

    for (let i = 0; i < cameras.length; i++) {

    let cards = document.createElement("div");
        newDiv.appendChild(cards);
        cards.classList.add("card", "container-sm");
        cards.src = cameras[i]._id
    
        // img
    let imgCam = document.createElement("img", "img-fluid");
