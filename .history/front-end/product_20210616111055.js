...
//// faire une boucle for
    ...
    document.getElementById("quantity")[0].addEventListener('input', function () {
    ...
    addToBasket.innerHTML = `<button class="btn minus-btn disabled" type="button">-</button>
        <input class="productQuantityInput" type="text" id="product_quantity_${this._id} quantity" value="1" placeholder="Maximum 3" 
        min="1" max="3">
