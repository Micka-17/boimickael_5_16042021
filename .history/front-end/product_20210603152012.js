...
class MyProduct {
  ...
  function createCardCamera(choosenCamera, idCamera) {
    ...
    const mainProduct = document.getElementById("product");
    mainProduct.appendChild(divParentParent);
    divParentParent.classList.add("d-flex","justify-content-evenly", "flex-wrap");
  
    let divParent = document.createElement("div");
    divParentParent.appendChild(divParent);
    divParent.classList.add("card", "container-sm", "m-5");
  
    let imageCamera = document.createElement("img");
    divParent.appendChild(imageCamera);
    imageCamera.classList.add("card-image-top", "photo", "img-fluid", "max-width:500px");
