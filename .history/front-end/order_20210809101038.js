...
for (let i = 0; i < savedValueProduct.length; i++) {
    ...
    newDiv2.classList.add("d-flex", "justify-content-between", "align-items-sm-center", "mx-5") 
...
divMaps.classList.add("d-flex", "card", "justify-content-evenly", "container-lg", "m-5", "mx-5")
