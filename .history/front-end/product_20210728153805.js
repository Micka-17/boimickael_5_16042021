    ...
    btnBasket.addEventListener("click", (event) => {
        ...
        if (localStorage.length === 0) {
            ...
            for (let i = 0; i < savedValue.length; i+=1) {
                ...
                if (infoProduit.titleArticle !== productOfCart.titleArticle && infoProduit.optionSelected !==productOfCart.optionSelected) {
                    console.log('if 1')
                    continue;
                }
            ...
            if (index === null) {
                ...
                savedValue[index].productQuantity.value += 1;
                savedValue.push(infoProduit);
                localStorage.setItem("product", JSON.stringify(savedValue));
            }
        }
