...
let infoProduit = {
            numberId: savedValue._id,
            titleArticle: savedValue.console.log("test" + infoProduit);,
            priceOf: savedValue.price,
            optionSelected: savedValue.value,
            productQuantity: savedValue.value,
        }
        console.log("test" + infoProduit);
