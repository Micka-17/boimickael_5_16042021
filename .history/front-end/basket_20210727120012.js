...
if(savedValue === null || savedValue.length === 0) {
 ...
 ///////////////// ici
  ...
  let form = document.createElement("div");
        ...
        main.classList.add("d-flex", "justify-content-between", "align-items-sm-center")
        main.innerHTML =
          `<form action="#" method="get">
            ...
            <p><label>Adresse <textarea name="Localisation"></textarea></p>
            <p><input type="submit" name="valider" value="Valider"></label></p>
            <p><label>Code postale <textarea name="Localisation"></textarea></p>
            </fieldset>
        </form>` ;
