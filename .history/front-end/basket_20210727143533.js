  ...
  let form = document.createElement("div");
        ...
        form.innerHTML =
          `<form action="#" method="get">
            ...
            <p class="userInput"><label>Nom <input type="text" name="nom"></label></p>
            <p class="userInput"><label>Prénom <input type="text" name="prenom"></label></p>
            <p class="userInput"><label>Tel <input type="text" maxlength="10" name="telephone"></label></p>
            <p class="userInput"><label>Email <input type="text" name="mail"></label></p>
            <p class="userInput"><label>Adresse <input type="text" name="localisation"></label></p>
            <p class="userInput"><label>Code postal <input type="text" name="zipcode"></label></p>
            <p class="userInput"><label>Ville <input type="text" name="city"></label></p>
            <p id="btnConfirmation" class="btn"><input type="submit" onclick="formulaire()" name="Confirmer ma commande" value="Valider"></label></p>
            </fieldset>
        </form>`;

        function formulaire() {
          let data = ""
          var input = document.querySelectorAll('.userInput input[type="text"]').value;
          alert(input);
          console.log(input);
      };
