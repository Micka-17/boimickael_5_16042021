  ...
  let empty = document.createElement("p");
    ...
    for (let i = 0; i < savedValue.length; i++) {
      ...
      let garbadge = document.createElement("div");
        ...
        min="1" max="3">
        <button class="btn plus-btn" type="button">+</button><button class="btn deleteMe"><i class="far fa-trash-alt"></i></button>`;
      ...
      // for (let j = 0; j < optionPresent.length; j++) {
       ...
       document.querySelectorAll(".plus-btn").addEventListener("click", function() {
       ...
       document.querySelectorAll(".minus-btn").addEventListener("click", function() {
           valueCount = document.getElementsByClassName("quantity").value;
           valueCount--;

           document.querySelectorAllAll("quantity").value = valueCount

           if(valueCount <= 1)
           {
               document.querySelectorAllAll(".minus-btn").setAttribute("disabled", "disabled");
           } 
           if(valueCount < 3)
           {
