  ...
  let empty = document.createElement('p');
    ...
    for (let i = 0; i < savedValue.length; i++) {
      ...
      let newDiv = document.createElement("p");
        ...
        newDiv.classList.add("d-flex", "card", "justify-content-evenly", "container-sm", "m-5")
        newDiv.textContent = savedValue[i].titleArticle;

      let newDiv1 = document.createElement("p");
        container.appendChild(newDiv1);
        newDiv1.classList.add("d-flex", "card", "justify-content-evenly", "container-sm", "m-5")
        newDiv1.textContent = savedValue[i].optionSelected;

      let newDiv2 = document.createElement("p");
        container.appendChild(newDiv2);
        newDiv2.classList.add("d-flex", "card", "justify-content-evenly", "container-sm", "m-5")
