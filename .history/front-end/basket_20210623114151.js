    ...
    for (let i = 0; i < savedValue.length; i++) {
      ...
      // for (let j = 0; j < optionPresent.length; j++) {
       ...
       document.getElementById(`".plus-btn ${savedValue[i].numberId}"`).addEventListener("click", function() {
           ...
           if(valueCount >= 3)
           {
               document.getElementById(`".plus-btn ${savedValue[i].numberId}"`).setAttribute("disabled", "disabled");
           } 
       ...
       document.getElementById(".minus-btn").addEventListener("click", function() {
           ...
           if(valueCount <= 1)
           {
               document.getElementById(".minus-btn").setAttribute("disabled", "disabled");
           } 
           if(valueCount < 3)
           {
               document.getElementById(`".plus-btn ${savedValue[i].numberId}"`).removeAttribute("disabled");
               document.getElementById(`".plus-btn ${savedValue[i].numberId}"`).classList.remove("disabled");
