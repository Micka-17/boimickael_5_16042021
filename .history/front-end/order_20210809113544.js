...
mainMaps.appendChild(newDiv);
divcontact.classList.add("d-flex", "card", "justify-content-evenly", "container-lg", "mx-5");
divcontact.textContent = `${savedValueLocation.nom} ${savedValueLocation.lastName} <br>
