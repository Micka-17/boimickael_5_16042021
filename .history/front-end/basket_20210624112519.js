  ...
  let empty = document.createElement("p");
    ...
    for (let i = 0; i < products.length; i++) {
      ...
      let garbadge = document.createElement("div");
        ...
        <input type="text" class="quantity" value="${products[i].productQuantity}" placeholder="Maximum 3" 
        min="1" max="3">
