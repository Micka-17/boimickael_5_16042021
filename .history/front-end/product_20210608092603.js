...
for (let i = 0; i < Allenses.length; i++) {
    const lens = document.createElement("option");
    addlens.appendChild(lens);
    lens.textContent = selectedProduct.lenses;
    ...
    addToBasket.innerHTML = `<a class="add" href="./basket.html"><i class="fas fa-cart-arrow-down"></i></a>`;
