...
document.querySelectorAll(".minus-btn").setAttribute("disabled", "disabled");
        ...
        document.querySelectorAll(".plus-btn")[i].addEventListener("click", function() {
            ...
            if(valueCount > 1)
            {
                document.querySelectorAll(".minus-btn")[i].removeAttribute("disabled");
                document.querySelectorAll(".minus-btn")[i].classList.remove("disabled");
            } 
        })

        document.querySelectorAll(".minus-btn")[i].addEventListener("click", function() {
            valueCount = document.getElementById("quantity").value;
            valueCount--;
            ...
            if(valueCount == 1)
            {
                document.querySelectorAll(".minus-btn")[i].setAttribute("disabled", "disabled");
            } 
});