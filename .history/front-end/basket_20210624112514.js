...
if(savedValue === null) {
  ...
  let empty = document.createElement("p");
    ...
    for (let i = 0; i < produ.length; i++) {
      const main = document.getElementById("product");
      console.log(produ[i].productQuantity);
      ...
      let garbadge = document.createElement("div");
        ...
        <input type="text" class="quantity" value="${produ[i].productQuantity}" placeholder="Maximum 3" 
        min="1" max="3">
