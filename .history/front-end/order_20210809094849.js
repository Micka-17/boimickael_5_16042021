...
let savedValueResponseId = JSON.parse(localStorage.getItem("responseId"));

console.log(savedValueResponseId);
...
let titleOrder = document.createElement("h2");
    ...
    title.textContent = `Merci pour votre commande numero ${savedValueResponseId.responseId}`; //orderId
...
divMaps.classList.add("d-flex", "card", "justify-content-evenly", "container-lg", "m-5")
