...
for (let i = 0; i < savedValueProduct.length; i++) {
    ...
    container.classList.add("d-flex", "card", "justify-content-evenly", "container-sm", "firstContainer", "my-5", "mx-2");
...
h4Price.textContent = `Montant total payer: ${savedValuePrice} €`;