...
btnForm.addEventListener("click", (e) => {
  ...
  const regexfirstName = /^[A-Za-z]{2-50}$/;
  const regexlastName = /^[A-Za-z]{2-50}$/;
  const regexNum = /^[0-9+]{9-12}$/;
  const regexEmail = /^[a-zA-Z0-9._-]+@[a-zA-Z0-9._-]{2,}\.[a-z]{2,4}$/;
  const regexAdresse = /^[A-Za-z0-9]{10-50}$/
  const regexCodePostale = /^[0-9]{3-6}$/;
