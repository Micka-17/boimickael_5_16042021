...
//// faire une boucle for
    ...
    let allLenses = selectedProductconsole.log(selectedOptions);
...
for (let i = 0; i < allLenses.length; i++) {
    ...
    const selectedOptions = document.querySelector(".selectionOption")
    console.log(selectedOptions);

    const choice = selectedOptions.value;
    console.log(selectedOptions)
};
