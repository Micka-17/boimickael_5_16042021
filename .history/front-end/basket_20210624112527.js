...
if(savedValue === null) {
  ...
  let empty = document.createElement("p");
    ...
    for (let i = 0; i < productsinCart.length; i++) {
      const main = document.getElementById("product");
      console.log(productsinCart[i].productQuantity);
      ...
      let garbadge = document.createElement("div");
        ...
        <input type="text" class="quantity" value="${productsinCart[i].productQuantity}" placeholder="Maximum 3" 
        min="1" max="3">
