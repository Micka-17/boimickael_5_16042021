...
function createCard (selectedProduct) {
    ...
    newDiv1.classList.add("d-flex","justify-content-evenly", "flex-wrap", "card", "center");
    ...
    const priceselected = document.createElement("p");
        description.appendChild(priceselected);
        priceselected.classList.add("d-flex", "justify-content-between");
        selectedProduct.textContent = selectedProduct.price + ' €';
}
