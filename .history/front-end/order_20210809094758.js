...
let savedValueResponsId = JSON.parse(localStorage.getItem("responseId"));
...
let titleOrder = document.createElement("h2");
    ...
    title.textContent = `Merci pour votre commande numero ${savedValueResponsrId.responseId}`; //orderId
