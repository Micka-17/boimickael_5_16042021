...
for (let i = 0; i < allLenses.length; i++) {
   ...
   // lens2.textContent = allLenses.lenses[2];
    ...
    let orderButton = document.getElementsByClassName("add");
    let itemList = document.getElementByClassName("selectionOption");
    let outputBox = document.getElementByClassName("output");
