...
<html lang="fr">
  <head>
    ...
    <script
      src="https://kit.fontawesome.com/7f2b024bdc.js"
    ...
    <div id="container">
      <header>
        <div class="top">
          <a href="../index.html">
            <img
              src="../back-end/images/Orinoco.png"
              alt="logo-orinoco"
              class="logo"
            />
          </a>
          <h1 id="title">Acheter different, Acheter malin</h1>
          <a class="main" href="../index.html"><i class="fas fa-home"></i></a>
          <a class="shop" href="../front-end/basket.html"
      ...
      <div class="midle">
        <!-- Emplacement des cards avec les différentes caméras disponibles dans l'API -->
        <main class="container" id="main">
          <!--Complèter avec le JS-->
        </main>
      </div>
    </div>
  </body>
  <footer>
    <div class="bottom">
      <div class="flex-footer">
        ...
        <a href="mailto:pasderemboursement@pigeon.fr" class="contact">
          Contact
        </a>
      </div>
    </div>
  ...
  <script
    ...
    crossorigin="anonymous"
  ></script>
  <script type="text/javascript" src="../front-end/order.js"></script>
</html>
