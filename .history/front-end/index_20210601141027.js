...
fetch('http://localhost:3000/api/cameras')
  ...
  .then((cameras) => {
    ...
    for(let i = 0; i < cameras.length; i++) {
      ...
      html += `<div class="list-group","justify-content-evenly", "flex-wrap">
...
function addElement (cameras) {
    ...
    let add = document.createElement('p');
        ...
        add.innerHTML = '<a class="add" href="./produit.html?${cameras[i]._id}"><i class="fas fa-cart-arrow-down"></i></a>';
    }
}
