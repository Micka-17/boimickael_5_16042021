...
const mainMaps = document.getElementById("main");
    ...
    mainMaps.innerHTML = `${savedValueLocation.nom} ${savedValueLocation.lastNameNocc} <br> <br>
    ${savedValueLocation.num} 
    ${savedValueLocation.adresse} ${savedValueLocation.codePostale} ${savedValueLocation.ville} <br>
    ${savedValueLocation.codePostale}`;