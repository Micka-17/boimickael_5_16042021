...
const title = document.querySelector(".midleconst main = document.querySelector(".midle-container");");

const main = document.querySelector(".midle-container");
...
const mainMaps = document.querySelector(".top-container");
