  ...
  let empty = document.createElement("p");
    ...
    for (let i = 0; i < savedValue.length; i++) {
      ...
      let garbadge = document.createElement("div");
        ...
        <input type="text" id="quantity ${savedValue[i].productQuantity}" value="${savedValue[i].productQuantity}" placeholder="Maximum 3" 
        min="1" max="3">
        ...
        console.log("quantity `${savedValue[i].productQuantity}"`);
