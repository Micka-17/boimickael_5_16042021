function createCardCameras(cameras) {
    ...
    for (let i = 0; i < cameras.length; i++) {
        ...
        divCardBody.classList.add("card-body", "text-center", "px-0", "d-flex", "flex-column", "justify-content-betwen");
        ...
        divLinkPrice.classList.add("d-flex", "flex-row", "justify-content-evenly");
...
function getUrlProduct(cameras,i,linkProduct) {
    ...
    let url = window.location.origin + window.location.pathname.replace(lastItem, '../frontend/product.html');
