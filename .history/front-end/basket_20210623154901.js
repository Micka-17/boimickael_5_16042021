      ...
      // for (let j = 0; j < optionPresent.length; j++) {
       ...
       for (j = 0; j < buttonsadd.length; j++) {
          ...
          e.preventDefault();
           ...
           valueCount++;
           console.log('click');
           const borther = this.previousElementSibling;
           console.log(borther);
           console.log(borther.previousElementSibling);
           console.log(this.parentElement.children);
           
           this.previousElementSibling.value = valueCount;

           if (valueCount > 1) {
            borther.previousElementSibling.removeAttribute("disabled");
            borther.previousElementSibling.classList.remove("disabled");
           } 
           if (valueCount >= 3) {
